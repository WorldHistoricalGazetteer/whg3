...
def new_emailer(email_type, subject, from_email, to_email, **kwargs):
  print(f'new_emailer(), email_type: {email_type}, subject: {subject}, from_email: {from_email}, to_email: {to_email}, kwargs: {kwargs}')
  reply_to = kwargs.get('reply_to', None)
  cc = kwargs.get('cc', None)
  bcc = kwargs.get('bcc', None)
  # align_idx() and align_wdlocal() pass status
