      ...
      },
      {
        ...
        'paint': {
          ...
          'circle-radius': [
            ...
            ['zoom'],
            9,
            ['interpolate', ['linear'], ['get', 'area'], 10, 0.1 * 5, 20, 2 * 2.5],
            16,
            ['interpolate', ['linear'], ['get', 'area'], 10, 1 * 5, 20, 20 * 2.5]
          ],
          ...
          'circle-color': [
            ...
            ['get', 'area'],
            20 * 0, "rgba(68, 1, 84, 0)",
            20 * 0.01, "rgba(68, 1, 84, 20)",
            20 * 0.13, "rgba(71, 44, 122, 100)",
            20 * 0.25, "rgba(59, 81, 139, 100)",
            20 * 0.38, "rgba(44, 113, 142, 100)",
            20 * 0.5, "rgba(33, 144, 141, 100)",
            20 * 0.63, "rgba(39, 173, 129, 100)",
            20 * 0.75, "rgba(92, 200, 99, 100)",
            20 * 0.88, "rgba(170, 220, 50, 100)",
            20 * 1, "rgba(253, 231, 37, 100)",
          ],
