...
class SearchView(View):
  ...
  def handle_request(request):
    ...
    print('SearchView() fclasses', request.GET.get('fclasses') or request.POST.get('fclasses'))
    """
      args in request.GET:
        [string] qstr: query string
  ...
  def handle_request(request):
    """
      args in request.GET:
        ...
        [string] countries: text of JSON cccodes array
    """
    print('SearchViewNew() request', request.GET or request.POST)
    qstr = request.GET.get('qstr') or request.POST.get('qstr')
    idx = settings.ES_WHG
    fclasses = request.GET.get('fclasses') or request.POST.get('fclasses')
    start = request.GET.get('start') or request.POST.get('start')
...
class SearchDatabaseView(View):
  ...
  def get(request):
    ...
    print('seaech db params:',
          {'name': name, 'name_contains': name_contains, 'fclasses': fclasses, 'bounds': bounds, 'ds': ds})
